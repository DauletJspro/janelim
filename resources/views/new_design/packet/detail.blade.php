                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="detial-holder">
                            ...
                            <div class="rank-rating">
                                ...
                                <span class="total-price">Отзывы (0)</span>
                            </div>                            
                            <div class="txt-wrap">
                                <p>{{$packet->packet_desc_ru}}</p>
                            </div>
                            <div class="text-holder">
                                <span class="price">Цена: &nbsp; ${{$packet->packet_price}} &nbsp; ({{$packet->packet_price * (\App\Models\Currency::where(['currency_id' => 1])->first())->money}} &#8376;)</span>
                            </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <ul class="mt-tabs text-center text-uppercase">
                            ...
                            <li><a href="#tab3" class="{{isset($tab[1]) && $tab[1] == 'review' ? 'active' : ''}}">Отзывы(0}
                                    )</a>
                            </li>
                        </ul>
                        <div class="tab-content">
                            ...
                            <div id="tab3">
                                <div class="product-comment">                                    
                                    ...
                                    {{ Form::token() }}
                                    {{ Form::hidden('item_id', $packet->packet_id) }}
                                ...
                                @foreach($relatedPacket as $packet)
                                    <div class="mt-product1 mt-paddingbottom20">
                                        <div class="box">
                                            <div class="b1">
                                                <div class="b2">
                                                    <a href="{{route('product.detail', ['id' => $packet->packet_id])}}">
                                                        <div style="
                                                                background-image: url('{{$packet->packet_image}}');
                                                                background-position: center;
                                                                background-repeat: no-repeat;
...
{{--															<span class="new">NEW</span>--}}
                                                    ...
                                                    <ul class="mt-stars">
                                                        @for($i = 0; $i<5;$i++)
                                                            @if($i < \App\Models\Review::ratingCalculator($packet->packet_id, \App\Models\Review::PRODUCT_REVIEW))
                                        ...
                                        <div class="txt">
                                            ...
                                            <span class="price"><i class="fa fa-dollar"></i>
                                                <span>
                                                    {{$packet->packet_price}} &nbsp;
                                                    ({{$packet->packet_price * \App\Models\Currency::usdToKzt()}} тг)
                                                </span>
                                            </span>
                                        </div>
                                    </div>
