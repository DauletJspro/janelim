        ...
        <div class="col-sm-3 col-lg-3 col-xs-6 col-md-4">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <p class="card-text"><?php echo e(round($pvData['pvProfitToday'],2)); ?> pv</p>
                    <p class="card-text"><?php echo e(round($pvData['pvProfitToday'] * \App\Models\Currency::PVtoKzt,2)); ?> &#8376; </p>
        ...
        <div class="col-sm-3 col-lg-3 col-xs-6 col-md-4">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <p class="card-text"><?php echo e(round($pvData['pvProfitLastWeek'],2)); ?> pv</p>
                    <p class="card-text"><?php echo e(round($pvData['pvProfitLastWeek'] * \App\Models\Currency::PVtoKzt,2)); ?> &#8376; </p>
                    <a href="#" class="btn btn-primary">Доход</a>
                </div>
            </div>
        </div>
        <div class="col-sm-3 col-lg-3 col-xs-6 col-md-4">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <p class="card-text"><?php echo e(round($pvData['pvProfitLastMonth'],2)); ?> pv</p>
                    <p class="card-text"><?php echo e(round($pvData['pvProfitLastMonth'] * \App\Models\Currency::PVtoKzt,2)); ?> &#8376; </p>
                    <a href="#" class="btn btn-primary">Доход</a>
                </div>
            </div>
        </div>
        <div class="col-sm-3 col-lg-3 col-xs-6 col-md-4">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <p class="card-text"><?php echo e(round($pvData['pvProfitAll'],2)); ?> pv</p>
                    <p class="card-text"><?php echo e(round($pvData['pvProfitAll'] * \App\Models\Currency::PVtoKzt,2)); ?> &#8376; </p>
                    <a href="#" class="btn btn-primary">Доход</a>
                </div>
            </div>
        </div>
